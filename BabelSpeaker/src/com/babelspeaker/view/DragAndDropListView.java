...
public class DragAndDropListView extends ListView {
    ...
    public DragAndDropListView(Context context, AttributeSet attrs) {
        ...
        mItemHeightNormal = res.getDimensionPixelSize(R.dimen.drag_drop_item_normal_height);
        ...
        if (mDragListener != null || mDropListener != null) {
            switch (ev.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    if (InitData.DEBUG) Log.v("queue", itemnum + "");
                    ...
                    View dragger =  new View(getContext());//TODO item.findViewById(R.id.sequenceDragImageView);
...
//                        Bitmap bitmap = Bitmap.createBitmap(item.get)
