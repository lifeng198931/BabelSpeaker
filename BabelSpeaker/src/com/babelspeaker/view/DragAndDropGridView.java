...
import com.babelspeaker.adapter.DragGridViewAdapter;
    ...
    public boolean setOnItemLongClickListener(final MotionEvent ev) {
        this.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
                ...
                if(specialPosition != dragPosition && dragPosition != -1 && specialPosition != -1){
                    specialItemY = getChildAt(specialPosition).getTop();
                }else{
                    specialItemY = -1;
                }
                if(leftBottomPosition != dragPosition && dragPosition != -1 && leftBottomPosition != -1){
                ...
                itemView.setDrawingCacheBackgroundColor(getResources().getColor(R.color.transparent));
...
//      windowParams.y = dragItemView.getTop()+(int)(45*Configure.screenDensity);
    ...
    private void onDrag(int x, int y) {
        if (dragImageView != null) {
            windowParams.alpha = 0.8f;
            windowParams.x = x - dragItemView.getWidth() / 2;//(x - mLastX - xtox) + dragItemView.getLeft() + 8;
            windowParams.y = y;//(y - mLastY - ytoy) + dragItemView.getTop()
                    //+ dragItemView.getHeight() / 2;
